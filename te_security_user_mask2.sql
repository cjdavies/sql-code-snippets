...
CREATE OR ALTER PROCEDURE [dbo].[te_security_user_mask2]
/* Tables used
dbo.security_mask (select)
dbo.security_user_mask (select, insert, update, delete)
dbo.security_user (select)
dbo.ref_access_code (select)
*/
  (                                     ---------
    ...
    BEGIN
      ...
      INSERT
        INTO dbo.security_user_mask
          (tenant_id, user_id, security_mask_id, access_code)
        VALUES
          (@tenant_id, @user_id, @security_mask_id, @access_code);
