...
/****** Object:  Database [Dev]    Script Date: 1/3/2025 1:04:11 PM ******/
CREATE DATABASE [Dev]
    CONTAINMENT = NONE
ON  PRIMARY 
( NAME = N'Dev', FILENAME = N'C:\MSSQL\Data\Dev.mdf' , SIZE = 10240KB , MAXSIZE = 102400KB , FILEGROWTH = 5120KB )
    LOG ON 
( NAME = N'Dev_log', FILENAME = N'C:\MSSQL\Logs\Dev_log.ldf' , SIZE = 5120KB , MAXSIZE = 102400KB , FILEGROWTH = 5120KB )
...
GO
ALTER DATABASE [Dev] SET TARGET_RECOVERY_TIME = 60 SECONDS 
GO
ALTER DATABASE [Dev] SET DELAYED_DURABILITY = DISABLED 
GO
ALTER DATABASE [Dev] SET ACCELERATED_DATABASE_RECOVERY = OFF  
GO
ALTER DATABASE [Dev] SET QUERY_STORE = ON
GO
ALTER DATABASE [Dev] SET QUERY_STORE (OPERATION_MODE = READ_WRITE, CLEANUP_POLICY = (STALE_QUERY_THRESHOLD_DAYS = 30), DATA_FLUSH_INTERVAL_SECONDS = 900, INTERVAL_LENGTH_MINUTES = 60, MAX_STORAGE_SIZE_MB = 1000, QUERY_CAPTURE_MODE = AUTO, SIZE_BASED_CLEANUP_MODE = AUTO, MAX_PLANS_PER_QUERY = 200, WAIT_STATS_CAPTURE_MODE = ON)
GO
